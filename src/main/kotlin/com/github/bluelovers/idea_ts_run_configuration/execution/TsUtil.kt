...
import com.github.bluelovers.idea_ts_run_configuration.lib.TsData
...
object TsUtil
{
	...
	fun compatibleFiles(event: AnActionEvent): List<VirtualFile>
	{
		...
		//logger2.debug("[idea_ts_run_configuration][compatibleFiles]" + files.size)
	...
	fun execute(project: Project, virtualFile: VirtualFile, debug: Boolean)
	{
		...
		//logger2.debug("[idea_ts_run_configuration][execute]" + configuration)
